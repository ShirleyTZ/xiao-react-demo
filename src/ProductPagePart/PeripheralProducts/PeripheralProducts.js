...
class PeripheralProducts extends Component {
  render() {
    const maths = {
      PPImgLeft1:"",
      PPImgLeft2:"",
    ...
    const ticksPre = Object.keys(maths).map(item => require("./PeripheralProductsImgs/"+ item + ".webp"));
    const ticksPre2 = Object.keys(maths2).map(item => require("./PeripheralProductsImgs/"+ item + ".jpg"));
    ...
    return(
      <div className="Home-product-sale">
        ...
        <ProductLumpForMore number8="Appliance-more-box" btn={lumpForMore} content="Home-appliance-more" visiable="Home-appliance-more disappear" contentDesc="Home-appliance-more-desc" thumb="Home-appliance-more-img" forMoreDesc="for-more-desc" imgForMoreSrc={LiuLan} forMoreImg="forMoreImg" />
      </div>
    )
  }
}
